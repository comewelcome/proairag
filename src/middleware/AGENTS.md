...
- JWT auth injects: user_id, user, is_tenant_admin, auth_mode
...
- tenant.py — TenantContextMiddleware, get_tenant_id, get_tenant, get_user_id, get_user, get_is_tenant_admin, get_auth_mode, TenantId, TenantDep, UserId, UserDep, IsTenantAdmin, AuthMode
